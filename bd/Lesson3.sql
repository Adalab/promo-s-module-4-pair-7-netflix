...
CREATE TABLE `rel_movies_actors` (
  ...
  `fkActor` int DEFAULT NULL,
  `fkMovie` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fkActor` (`fkActor`),
  KEY `fkMovie` (`fkMovie`),
  CONSTRAINT `rel_movies_actors_ibfk_1` FOREIGN KEY (`fkActor`) REFERENCES `actors` (`id_actor`),
  CONSTRAINT `rel_movies_actors_ibfk_2` FOREIGN KEY (`fkMovie`) REFERENCES `movies` (`id_movies`)
...
CREATE TABLE `rel_movies_users` (
  ...
  KEY `fkUser` (`fkUser`),
  KEY `fkMovie` (`fkMovie`),
  CONSTRAINT `rel_movies_users_ibfk_1` FOREIGN KEY (`fkUser`) REFERENCES `users` (`id_user`),
  CONSTRAINT `rel_movies_users_ibfk_2` FOREIGN KEY (`fkMovie`) REFERENCES `movies` (`id_movies`)
...
INSERT INTO `rel_movies_users` VALUES (1,1,2),(2,3,2);
...
-- Dump completed on 2023-03-30 10:31:24
